...
import drawerlayoutView.AboutMe;
import drawerlayoutView.HistoryOfDhaka;
...
public class MainActivity extends Activity {
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			fragment = new HistoryOfDhaka();

			break;
		case 2:
			fragment = new PictureofDhaka();
			break;
		case 3:
